...
-- co	=>  Location: PIN_A12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF jpd_mux_2x1_8bit IS
...
-- Equation(s):
-- \inst7|inst2~0_combout\ = (\co~input_o\ & (\B[7]~input_o\)) # (!\co~input_o\ & ((\A[7]~input_o\)))
...
-- Equation(s):
-- \inst6|inst2~0_combout\ = (\co~input_o\ & ((\B[6]~input_o\))) # (!\co~input_o\ & (\A[6]~input_o\))
...
-- Equation(s):
-- \inst5|inst2~0_combout\ = (\co~input_o\ & ((\B[5]~input_o\))) # (!\co~input_o\ & (\A[5]~input_o\))
...
-- Equation(s):
-- \inst4|inst2~0_combout\ = (\co~input_o\ & ((\B[4]~input_o\))) # (!\co~input_o\ & (\A[4]~input_o\))
...
-- Equation(s):
-- \inst3|inst2~0_combout\ = (\co~input_o\ & ((\B[3]~input_o\))) # (!\co~input_o\ & (\A[3]~input_o\))
...
-- Equation(s):
-- \inst2|inst2~0_combout\ = (\co~input_o\ & ((\B[2]~input_o\))) # (!\co~input_o\ & (\A[2]~input_o\))
...
-- Equation(s):
-- \inst1|inst2~0_combout\ = (\co~input_o\ & (\B[1]~input_o\)) # (!\co~input_o\ & ((\A[1]~input_o\)))
...
-- Equation(s):
-- \inst|inst2~0_combout\ = (\co~input_o\ & ((\B[0]~input_o\))) # (!\co~input_o\ & (\A[0]~input_o\))
